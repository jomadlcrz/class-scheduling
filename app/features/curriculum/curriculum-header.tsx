...
const actionButtonClassName =
  "grid size-8 shrink-0 cursor-pointer place-items-center rounded-lg text-slate-400 transition-colors duration-150 hover:bg-slate-200/60 hover:text-navy-700 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gold-400 dark:text-slate-500 dark:hover:bg-white/10 dark:hover:text-white";
          ...
          <div className="flex shrink-0 items-center gap-1">
            {onEditProgram && (
              <button
                ...
                aria-label={`Edit ${selectedProgram.abbrev}`}
                title="Edit program"
