...
const config = {
  slots: { label: "Slots", color: "var(--chart-1)" },
        ...
        <AreaChart data={data} margin={{ top: 4, right: 12, left: 12, bottom: 0 }}>
          <defs>
            <linearGradient id="fillSlots" x1="0" y1="0" x2="0" y2="1">
              <stop offset="5%"  stopColor="var(--color-slots)" stopOpacity={0.8} />
              <stop offset="95%" stopColor="var(--color-slots)" stopOpacity={0.1} />
            </linearGradient>
          </defs>
          <CartesianGrid
            vertical={false}
