...
export type SemesterFormValue = { semester: string; semesterNumber: number };
...
export function SemesterForm({ initialValue, onSubmit, onCancel }: SemesterFormProps) {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    const result = semesterSchema.safeParse({ semester: semesterName, semesterNumber: Number(leadingDigit) });
    if (!result.success) {
