...
const cardFooterLinkClassName =
  "flex items-center justify-between gap-2 border-t border-slate-200 bg-slate-50 px-4 py-2.5 font-body text-sm font-medium text-blue-700 transition-colors duration-150 hover:bg-blue-50 hover:text-blue-800 dark:border-white/10 dark:bg-white/5 dark:text-blue-300 dark:hover:bg-blue-400/10 dark:hover:text-blue-200";
