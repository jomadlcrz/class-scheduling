    ...
    <div className="rounded-xl border border-red-200 bg-red-50 p-4 dark:border-red-500/20 dark:bg-red-500/10">
      <div className="flex flex-wrap items-start justify-between gap-2">
        <div>
          ...
          <p className="mt-0.5 font-sans text-xs text-red-600 dark:text-red-400">
...
function ScheduleChip({ schedule: s }: { schedule: Conflict["scheduleA"] }) {
  return (
    ...
    >
      <p className="font-sans text-xs font-semibold text-navy-700 dark:text-white">
        {s.subjectCode}
      </p>
      <p className="font-sans text-xs text-slate-500 dark:text-slate-400">{s.subjectTitle}</p>
