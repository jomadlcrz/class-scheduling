...
export function openInstructorSchedulePrint(
  schedules: Schedule[],
  context: { schoolYear: string; semesterLabel: string; instructorName: string },
): boolean {
...
<head>
  ...
  <style>
    *{box-sizing:border-box;margin:0}
    ...
    .sp-day td:nth-child(1),.sp-day th:nth-child(1){width:14%;text-align:center;white-space:nowrap}
    .sp-day td:nth-child(2),.sp-day th:nth-child(2){width:11%;text-align:center}
    .sp-day td:nth-child(3),.sp-day th:nth-child(3){width:22%}
    .sp-day td:nth-child(4),.sp-day th:nth-child(4){width:10%;text-align:center}
    .sp-day td:nth-child(5),.sp-day th:nth-child(5){width:13%;text-align:center}
    .sp-day td:nth-child(6),.sp-day th:nth-child(6){width:9%;text-align:center}
    .sp-day td:nth-child(7),.sp-day th:nth-child(7){width:11%;text-align:center}
