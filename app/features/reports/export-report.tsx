        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <button
              type="button"
              onClick={handlePrint}
              className="mt-3 inline-flex items-center gap-1.5 rounded-lg bg-navy-700 px-4 py-2 font-sans text-sm font-medium text-white transition-colors hover:bg-navy-800 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gold-400 dark:bg-gold-500 dark:text-navy-900 dark:hover:bg-gold-400"
            >
              <PrinterIcon />
              Print / Save as PDF
            </button>
