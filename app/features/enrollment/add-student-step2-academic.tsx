...
type AddStudentStep2AcademicProps = {
...
export function AddStudentStep2Academic({
  academic,
  onAcademicChange,
  programs,
  sets,
            ...
            <FieldChrome id="new-student-program" label="Program" required>
              {programs.length > 0 ? (
                ...
                <div className="flex flex-col gap-1 rounded-lg border border-slate-200 bg-slate-50 p-2.5 text-xs text-slate-600 dark:border-white/10 dark:bg-white/5 dark:text-slate-400">
                  ...
                  <p>Create a program curriculum before adding students.</p>
                </div>
              )}
            </FieldChrome>
