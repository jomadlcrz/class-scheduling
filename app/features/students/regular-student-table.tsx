...
import type { RegularStudentRow, StudentAccountRow } from "~/types/student";

const actionButtonClassName =
  "grid size-8 cursor-pointer place-items-center rounded-lg text-slate-400 transition-colors duration-150 hover:bg-slate-200/60 hover:text-navy-700 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gold-400 dark:text-slate-500 dark:hover:bg-white/10 dark:hover:text-white";

type RegularStudentTableProps = {
  students: RegularStudentRow[];
  onView?: (student: RegularStudentRow) => void;
  onEnroll?: (student: RegularStudentRow) => void;
...
function toAccountRow(s: RegularStudentRow): StudentAccountRow {
  return {
...
export function RegularStudentTable({
  students,
  onView,
  onEnroll,
  accountLookup,
