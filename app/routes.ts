...
export default [
  ...
  layout("layouts/app-shell.tsx", [
    ...
    route("dean/instructor-availability", "routes/app/dean-instructor-availability.tsx"),
    route("faculty", "routes/app/faculty.tsx"),
    route("faculty/new", "routes/app/faculty-new.tsx"),
    route("faculty/my-availability", "routes/app/faculty-my-availability.tsx"),
    route("faculty/my-subjects", "routes/app/faculty-my-subjects.tsx"),
    ...
    route("profile/academic", "routes/app/profile/academic.tsx"),
    route("profile/address", "routes/app/profile/address.tsx"),
    route("profile/appearance", "routes/app/profile/appearance.tsx"),
