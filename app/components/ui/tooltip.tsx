      ...
      {visible &&
        ...
        createPortal(
          <div
            ...
            className={`pointer-events-none fixed z-50 rounded-md bg-slate-900 px-2.5 py-1.5 font-body text-xs font-semibold text-slate-100 shadow-lg transition-[opacity,transform] duration-150 dark:bg-white dark:text-navy-800 ${
