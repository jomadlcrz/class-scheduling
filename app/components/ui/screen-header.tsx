...
export function ScreenHeader({
  ...
  return (
    <header
      className={`sticky top-0 z-30 flex h-14 w-full shrink-0 items-center justify-between border-b border-slate-200 bg-white/95 px-4 sm:px-6 backdrop-blur-md dark:border-white/10 dark:bg-surface-raised/95 ${className}`}
    >
