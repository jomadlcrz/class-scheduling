    ...
    <>
      ...
      <div className="pointer-events-none fixed inset-0 z-50 grid place-items-center p-4">
        <motion.div
          ...
          className="pointer-events-auto flex max-h-[calc(100dvh-2rem)] w-full max-w-md flex-col rounded-xl border border-[#d9e3ef] bg-white p-6 shadow-xl dark:border-white/10 dark:bg-navy-900"
        >
