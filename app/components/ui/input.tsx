...
export const inputClassName =
  "w-full rounded-lg border border-slate-300 bg-white px-3 py-2 font-body text-sm text-navy-800 placeholder-slate-400 outline-none transition-colors duration-150 focus-visible:border-gold-400 focus-visible:ring-2 focus-visible:ring-gold-400 disabled:cursor-not-allowed disabled:bg-slate-50 disabled:text-slate-400 dark:border-white/15 dark:bg-white/5 dark:text-mist-100 dark:placeholder-slate-500 dark:focus-visible:border-gold-400 dark:disabled:bg-white/3 dark:disabled:text-slate-500";
